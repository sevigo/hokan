...
// Source: github.com/sevigo/hokan/pkg/core (interfaces: Backup,DB,DirectoryStore,EventCreator,FileStore,MinioWrapper,Notifier,ServerSideEventCreator,UserStore,Watcher)
...
// Find mocks base method.
func (m *MockFileStore) Find(arg0 context.Context, arg1 string, arg2 *core.FileSearchOptions) (*core.File, error) {
	m.ctrl.T.Helper()
...
// List mocks base method.
func (m *MockFileStore) List(arg0 context.Context, arg1 string, arg2 *core.FileListOptions) ([]*core.File, error) {
	m.ctrl.T.Helper()
...
// List indicates an expected call of List.
func (mr *MockFileStoreMockRecorder) List(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockFileStore)(nil).List), arg0, arg1, arg2)
}
