...
// Source: github.com/sevigo/hokan/pkg/core (interfaces: ConfigStore,DB,DirectoryStore,EventCreator,FileStore,MinioWrapper,Notifier,ServerSideEventCreator,TargetStorage,TargetStorageConfigurator,TargetRegister,UserStore,Watcher)
